...
CREATE TABLE `sys_event_config`  (
  ...
  `NEED_PERSIST` tinyint(1) NULL DEFAULT NULL COMMENT '是否重试',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user`  (
  ...
  `account` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  COMMENT '用户账号',
  `pwd` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci  COMMENT '用户密码',
  ...
  `nickname` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci  COMMENT '用户昵称',
  `avatar` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci   COMMENT '用户头像',
