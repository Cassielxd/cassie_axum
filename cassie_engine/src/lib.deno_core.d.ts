...
declare namespace Cassie {
  namespace core {
     ...
     *   - To indicate the end of the resource, use `Cassie.core.close()` with the
     *     rid.
     */
     ...
     * debugging of where a given async op was started. cassie CLI uses this for
     * improving error message in op sanitizer errors for `cassie test`.
     *
     ...
     * Tracing only occurs when `Cassie.core.enableOpCallTracing()` was previously
     * enabled.
     */
