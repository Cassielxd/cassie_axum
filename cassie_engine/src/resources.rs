...
/// considered to be the Cassie equivalent of a `file descriptor` in POSIX like
/// operating systems. Elsewhere in the code base it is commonly abbreviated
/// to `rid`.
// TODO: use `u64` instead?
pub type ResourceId = u32;

/// Map-like data structure storing Cassie's resources (equivalent to file
/// descriptors).
///
...
impl ResourceTable {
    ...
    ///
    /// ```
    /// # use cassie_engine::ResourceTable;
