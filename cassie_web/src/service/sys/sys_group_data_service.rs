...
use cassie_domain::{
  dto::sys_group_data_dto::SysGroupDataDTO,
  entity::sys_group_data_entity::SysGroupData, request::SysGroupDataQuery,
};
...
impl CrudService<SysGroupData, SysGroupDataDTO, SysGroupDataQuery>
  for SysGroupDataService
{
