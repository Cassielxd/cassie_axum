...
use cassie_domain::{
  dto::sys_role_dto::SysRoleDataScopeDTO,
  entity::sys_entitys::SysRoleDataScope, request::SysRoleQuery,
};
...
impl SysRoleDataScopeService {
  ...
  pub async fn delete_by_role_id(&self, role_id: i64) {
    self
      .del_by_column(SysRoleDataScope::role_id(), &role_id.to_string())
      .await;
  }
}
impl CrudService<SysRoleDataScope, SysRoleDataScopeDTO, SysRoleQuery>
  for SysRoleDataScopeService
{
