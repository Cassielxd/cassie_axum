...
use cassie_domain::{
  dto::sys_role_dto::SysRoleUserDTO, entity::sys_entitys::SysRoleUser,
...
impl CrudService<SysRoleUser, SysRoleUserDTO, SysRoleQuery>
  for SysRoleUserService
{
