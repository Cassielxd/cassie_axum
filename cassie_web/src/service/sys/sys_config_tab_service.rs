...
use cassie_domain::{
  dto::sys_config_tab_dto::SysConfigTabDTO,
  entity::sys_config_tab_entity::SysConfigTab, request::SysConfigTabQuery,
};
...
impl CrudService<SysConfigTab, SysConfigTabDTO, SysConfigTabQuery>
  for SysConfigTabService
{
